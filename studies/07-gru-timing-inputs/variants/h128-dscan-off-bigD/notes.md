# h128-dscan-off-bigD — timing-OFF paired baseline, large cohorts

Experiment `01M0NDR91DA7H79G71B1HVHYAR` (6 tasks: subject_ratio 0.489, 1.0 x 3 seeds).
...
**Split by TIER, not by D.** This variant takes the **allocated / protected**
tier (`{priority: high, preemptible: false}`) — 6 of the 8 guaranteed slots.
