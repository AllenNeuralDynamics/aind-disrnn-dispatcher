...
stage-2b session-conditioned run (05wwp6k4), using the TRAINING CODE's own reconstruction
...
Writes stage2b_embedding_trajectories.csv: subject_id, session_id, session_phase,
...
if __name__ == "__main__":
    ...
    out.to_csv("stage2b_embedding_trajectories.csv", index=False)
    print(f"WROTE stage2b_embedding_trajectories.csv: {out.shape[0]} rows, "
