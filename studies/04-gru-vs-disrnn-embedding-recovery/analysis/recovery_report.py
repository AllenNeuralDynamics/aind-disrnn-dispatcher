...
def _update_reports(ladder, s4b, dis):
    ...
    stage_figs = [
        ...
        ("stage3_baseline_vs_gru_confusion.png",
         ...
         "fitter (wandb run qy9lof3x) and is correctly assigned for 8/67 true-RW subjects — up "
         "from a structural 0/67 under the earlier 3-fitter setup. Most true-RW subjects (35/67) "
         "still get misassigned to Bari and 19/67 to Hattori, pointing to RescorlaWagner being "
