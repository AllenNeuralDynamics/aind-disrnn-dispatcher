...
| `gru-stage4b-concentration` | 4b | GRU | per-session switching, **Dirichlet-concentration sweep** | conc{0.5,1,2,5}×{none,scalar}×seed{42,43} | grp `@20260712-060852` (resumable) | ✅ done → [r3](analysis/reports/r3-stage4b-concentration.md) | Stage-4b null is **architectural**: SC gap ≈0 at every α; SC encodes session *position* (R²≈0.6), not the discrete family |
