#!/usr/bin/env python
"""Update Result 7 in reports/r7-nxd-joint-scaling-grid.md from nxd_scaling.json.

Rewrites only the region between the BEGIN/END HTML-comment markers in the
report file; the markers themselves are preserved so the regenerator can find
...
REPORT = HERE / "reports" / "r7-nxd-joint-scaling-grid.md"
NXD_JSON = HERE / "nxd_scaling.json"
START = "<!-- BEGIN result-7 -->"
END = "<!-- END result-7 -->"
