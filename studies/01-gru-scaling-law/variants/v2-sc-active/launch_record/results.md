...
- Key numbers: 15 cells (D in {10, 30, 100, 300, 614} x 3 seeds, H=128); held-out per-trial likelihood 0.7218 -> 0.7282 as D 10 -> 614; v2-v1 large-D Delta ~ +0.00146 (per analysis/reports/r1).
- Feeds reports:
