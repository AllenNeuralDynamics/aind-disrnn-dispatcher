...
```bash
cd /path/to/parent/aind-dynamic-foraging-bfm-dispatcher
...
python code/launch_hpc.py --mode gpu --wrapper-root /path/to/aind-dynamic-foraging-bfm-wrapper
```
